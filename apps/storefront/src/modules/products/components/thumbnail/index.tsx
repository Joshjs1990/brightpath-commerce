...
const Thumbnail: React.FC<ThumbnailProps> = ({
  ...
  return (
    <Container
      className={clx(
        "relative w-full overflow-hidden bg-[#f3f1ed] shadow-none rounded-none transition-transform duration-500 ease-out group-hover:-translate-y-1",
        className,
        {
  ...
  return image ? (
    <Image
      ...
      className={clx("absolute inset-0 object-center", {
        ...
        "object-contain p-5 small:p-7": fit === "contain",
      })}
      draggable={false}
      quality={50}
